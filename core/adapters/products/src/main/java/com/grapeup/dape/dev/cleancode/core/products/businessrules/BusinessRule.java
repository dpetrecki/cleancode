...
public interface BusinessRule {
    ...
    default boolean isAvailable(Filterable filterable, String userId, String deviceId) {
        return switch (filterable) {
            ...
            case FilterableProduct.FilterableService element -> isAvailable(element, userId, deviceId);
        };
    }
    ...
    default boolean isAvailable(FilterableProduct.FilterableService element, String userId, String deviceId) {
        return true;
    }
}
